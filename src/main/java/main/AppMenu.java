...
public class AppMenu {
    ...
    public AppMenu() {
        ...
        EmpleadoServiceImpl personaService = createPersonaService();
        this.menuHandler = new MenuHandler(scanner, personaService); /** Esto se arregla cuando este completo el manejador de menu **/
        this.running = true;
    }
    ...
    /** ESTA ULTIMA PARTE NO ME QUEDA CLARA POR ESO NO LA MODIFIQUE TODAVIA ----
    /**
